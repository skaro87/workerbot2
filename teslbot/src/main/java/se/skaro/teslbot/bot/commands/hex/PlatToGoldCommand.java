...
/**
 * The Class PlatToGoldCommand. Used to look up an input in Platinum to Gold. Uses the ratio from the prize data. HEX specific command. 
 */
@Component
public class PlatToGoldCommand extends AbstractCommand {
	...
	public void call(ChatBot bot, String sender, String message, String channel) {
		...
		String input = fixWhiteSpaces(getMessageWithoutCommand(config.getMessagePrefix() + "ptg", message));
